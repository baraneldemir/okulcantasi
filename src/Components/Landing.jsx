...
export default function Landing() {
    return (
        <>
        <div style={{ backgroundImage: `url(${arkaplan})` }} className="relative flex flex-col items-center h-screen px-6 bg-fixed bg-cover lg:flex-row bg-slate-300 lg:px-20">
            <div
