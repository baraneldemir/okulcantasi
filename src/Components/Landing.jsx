...
export default function Landing() {
    return (
        <>
        <div style={{ backgroundAttachment:'fixed', backgroundImage: `url(${arkaplan})` }} className="relative flex flex-col items-center h-screen px-6 bg-cover lg:flex-row bg-slate-300 lg:px-20">
            <div
